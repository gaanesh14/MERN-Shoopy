...
function Footer() {
  return (
     <footer className='border-t py-12'>
            ...
            <div>
                ...
                <form className='flex'>
                    <input
                     ...
                     className='p-3 w-full text-sm border-t border-l border-b border-gray-300 rounded-1-md
                     focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all'
                     required
                    />
                    <button type="submit" className='bg-black text-white px-6 p-3 text-sm rounded-r-md hover:bg-gray-800 transition-all'> Subscribe </button>
                </form>
            </div>
            <div>
        ...
        <div className='mx-container mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6'>
